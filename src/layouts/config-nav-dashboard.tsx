   ...
   */
  {
    ...
    items: [
...

      {
        ...
        path: paths.dashboard.farmer.root,
        icon: ICONS.banking,
        children: [
          { title: 'Coop-Farmers', path: paths.dashboard.farmer.root },
          { title: 'New farmer', path: paths.dashboard.farmer.newCoopFarmer },
          { title: 'Harvest', path: paths.dashboard.farmer.harvest },
          { title: 'GRN', path: paths.dashboard.farmer.grn },
          { title: 'Invoice', path: paths.dashboard.farmer.invoice },
          { title: 'Warehouse Receipt', path: paths.dashboard.farmer.warehouse },
          { title: 'Tasks', path: paths.dashboard.farmer.tasks, icon: ICONS.analytics },
        ],
      },
      {
